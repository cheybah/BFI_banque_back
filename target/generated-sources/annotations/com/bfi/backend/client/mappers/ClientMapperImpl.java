...
public class ClientMapperImpl implements ClientMapper {
    ...
    public Client signUpToClient(SignUpDto signUpDto) {
        ...
        client.additionalInfo( toAdditionalInfo( signUpDto.additionalInfo() ) );
    ...
    public ClientDto toClientDto(Client Client) {
        ...
        clientDto.additionalInfo( toAdditionalInfoDto( Client.getAdditionalInfo() ) );
    ...
    public PersonnePhysique signUpToPersonnePhysique(SignUpPersonnePhysiqueDto ClientDto) {
        ...
        personnePhysique.additionalInfo( toAdditionalInfo( ClientDto.additionalInfo() ) );
    ...
    public PersonneMorale signUpToPersonneMorale(SignUpPersonneMoraleDto ClientDto) {
        ...
        personneMorale.additionalInfo( toAdditionalInfo( ClientDto.additionalInfo() ) );
